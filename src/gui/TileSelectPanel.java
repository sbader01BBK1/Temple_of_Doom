...
public class TileSelectPanel extends JPanel {
    ...
    private final String BACKGROUND_PATH = ROOT + "info_texture.png";            //Location of background image
    private final JLabel instructions;            //Tells user how to use this panel
